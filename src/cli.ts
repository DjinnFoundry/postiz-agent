...
program
  ...
  .option('--link <l>', 'podcast website', 'https://audiokids.org')
  .option('--author <a>', 'podcast author', 'AudioKids')
  .option('--email <e>', 'owner email', 'hello@audiokids.org')
  .option('--image <i>', 'cover image URL', 'https://audiokids.org/podcast-cover.png')
  .action(async (opts) => {
